...
\fancyhead[LO]{MTH 345 - Homework \#3} %header top left
\fancyfoot[CO]{Page \thepage} %page center bottom

\noindent \textbf{Math 345 - Homework 3} \hspace{2.7in} \textbf{Due Friday, September 23, 2022}
\raggedright
\begin{enumerate}
  \item \input{question1.tex}\newpage
  \item \input{question2.tex}\newpage
  \item \input{question3.tex}\vspace{1cm}
  \item \input{question4.tex}\vspace{1cm}
  \item \input{question5.tex}\vspace{0.1in}
  \item \input{question6.tex}\vspace{1cm} 
\end{enumerate}
\end{document} 