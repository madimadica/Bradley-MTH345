...
\fancyhead[LO]{MTH 345 - Homework \#5} %header top left
\fancyfoot[CO]{Page \thepage} %page center bottom

\noindent \textbf{Math 345 - Homework 5} \hspace{2.7in} \textbf{Due Friday, October 7, 2022}
\raggedright
\begin{enumerate}
    \item \input{question1.tex}\newpage
    \item \input{question2.tex}\vspace{.5in}
    \item \input{question3.tex}\vspace{1cm}
    \item \input{question4.tex}
\end{enumerate}
\end{document} 